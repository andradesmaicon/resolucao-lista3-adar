...
```{r}
# Escrevendo no formato xlsx
#library(WriteXLS)
#arquivo_xls_temp <- file.path(getwd(), "previsoes-enos")

#WriteXLS(x = previsoes_enos_jun2020, ExcelFileName = arquivo_xls_temp)

#file.exists(arquivo_xls_temp)

#WriteXLS(x = previsoes_enos_jun2020, ExcelFileName = )
...
# importando o arquivo netcdf através do pacote raster
